...
public class SkillList {
	...
	public static void main(String[] args) {
		...
		Spell fireblast = new activeSkill("Fireblast","fire fixes everything",50,"",10);
        ...
        Spell reignOfIce = new activeSkill("Reign of Ice","Ice ice baby",50,"",10);
        ...
        Spell meditate = new activeSkill("Meditate","too much causes hallucinations",50,"",10);
        Spell waterNebula = new activeSkill("Water Nebula","Agua Novela",50,"",10);
        Spell Runesave = new activeSkill("Runesave","No mp to give",50,"",10);
        ...
        Spell deathRay = new activeSkill("Death Ray","why not",50,"",1000);
        ...
        activeSkill SpeedRun = new activeSkill("Speed Run","go fast",50,"",10);
        ...
        spellList.add(manaGuard);
        spellList.add(energyBolt);
        spellList.add(reignOfIce);
        spellList.add(gravityCore);
        spellList.add(explosion);
        spellList.add(meditate);
        spellList.add(waterNebula);
        spellList.add(Runesave);
        spellList.add(forbiddenTomb);
        spellList.add(rockCrush);
        spellList.add(deathRay);
