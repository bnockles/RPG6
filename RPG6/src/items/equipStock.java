...
public class equipStock {
	...
	public static Equipment equipStocks(int type) {
		...
		if (type == M_WD){
			return new Equipment("Mithril Wand", "REQ: 15 INT", "", 5, new Stats(15, 0, 0, 15, 10, 3), 100);
		}
		if (type == F_WD){
			return new Equipment("Fairy's Wand", "REQ: 35 INT, 20 WIS", "", 5, new Stats(50, 0, 0, 35, 24, 5), 100);
		}
		if (type == A_WD){
			return new Equipment("Angel's Wand", "REQ: 75 INT, 50 WIS", "", 5, new Stats(80, 0, 0, 80, 60, 10), 100);
		}
		if (type == E_SF){
			return new Equipment("Emerald Staff", "REQ: 10 INT", "", 5, new Stats(8, 0, 0, 10, 10, 1), 100);
		}
		if (type == R_SF){
			return new Equipment("Emerald Staff", "REQ: 45 INT", "", 5, new Stats(40, 0, 0, 50, 40, 5), 100);
		}
		if (type == Q_SF){
			return new Equipment("Queen's Staff", "REQ: 75 INT", "", 5, new Stats(70, 0, 0, 75, 50, 10), 100);
		}
		if (type == S_SF){
			return new Equipment("Sun Goddess's Staff", "REQ: 100 INT", "", 5, new Stats(90, 0, 0, 100, 65, 20), 100);
		}
		if (type == W_SR){
			return new Equipment("Wooden Spear", "REQ: 5 STR", "", 5, new Stats(5, 5, 1, 0, 0, 1), 100);
		}
		if (type == G_SR){
			return new Equipment("Golden Spear", "REQ: 20 STR", "", 5, new Stats(20, 20, 3, 0, 0, 3), 100);
		}
		if (type == B_SR){
			return new Equipment("Battle Axe Spear", "REQ: 50 STR", "", 5, new Stats(50, 50, 5, 0, 0, 5), 100);
		}
		if (type == SR_D){
			return new Equipment("Spear of Destruction", "REQ: 99 STR", "", 5, new Stats(120, 100, 10, 1, 1, 10), 100);
		}
		if (type == G_HR){
			return new Equipment("Golden Hammer", "REQ: 5 STR", "", 5, new Stats(5, 5, 1, 0, 0, 1), 100);
		}
		if (type == M_HR){
			return new Equipment("Mithril Hammer", "REQ: 15 STR", "", 5, new Stats(15, 15, 3, 0, 0, 3), 100);
		}
		if (type == D_HR){
			return new Equipment("Diamond Hammer", "REQ: 35 STR", "", 5, new Stats(35, 35, 5, 0, 0, 5), 100);
		}
		if (type == P_HR){
			return new Equipment("Poppy's Hammer", "REQ: 70 STR", "", 5, new Stats(70, 70, 10, 0, 0, 10), 100);
		}
		if (type == W_SD){
			return new Equipment("Wooden Shield", "REQ: 5 STR", "", 5, new Stats(5, 5, 1, 0, 0, 1), 100);
		}
		if (type == I_SD){
			return new Equipment("Iron Shield", "REQ: 15 STR", "", 5, new Stats(15, 15, 3, 0, 0, 3), 100);
		}
		if (type == T_WL){
			return new Equipment("Tank's Will", "REQ: 30 STR", "", 5, new Stats(30, 30, 5, 0, 0, 5), 100);
		}
		if (type == GS_D){
			return new Equipment("God's Shield", "REQ: 100 STR", "", 5, new Stats(100, 100, 10, 10, 10, 10), 100);
		}
		if (type == W_CE){
			return new Equipment("Wooden Chestplate", "REQ: NONE", "", 2, new Stats(10, 10, 10, 10), 100);
		}
		if (type == I_CE){
			return new Equipment("Iron Chestplate", "REQ: 15 STR", "", 2, new Stats(20, 20, 20, 20), 100);
		}
		if (type == D_CE){
			return new Equipment("Diamond Chestplate", "REQ: 40 STR", "", 2, new Stats(40, 40, 30, 30), 100);
		}
		if (type == D_AR){
			return new Equipment("Devil's Armor", "REQ: 999 STR", "", 2, new Stats(500, 500, 99, 99), 100);
		}
		if (type == L_PT){
			return new Equipment("Leather Pants", "REQ: 5 STR", "", 3, new Stats(5, 5, 0, 0), 100);
		}
		if (type == S_PT){
			return new Equipment("Silk Pants", "REQ: 15 STR", "", 3, new Stats(15, 15, 1, 1), 100);
		}
		if (type == GW_P){
			return new Equipment("God Woven Pants", "REQ: 50 STR", "", 3, new Stats(50, 55, 3, 3), 100);
		}
		if (type == F_LG){
			return new Equipment("Forsaken Leggings", "REQ: 100 STR", "", 3, new Stats(100, 100, 5, 5), 100);
		}
		if (type == S_HT){
			return new Equipment("Straw Hat", "REQ: 5 STR", "", 1, new Stats(5, 5, 1, 1), 100);
		}
		if (type == I_HT){
			return new Equipment("Iron Helmet", "REQ: 20 STR", "", 1, new Stats(20, 20, 3, 3), 100);
		}
		if (type == P_HT){
			return new Equipment("Plat Helmet", "REQ: 55 STR", "", 1, new Stats(55, 50, 5, 5), 100);
		}
		if (type == S_HD){
			return new Equipment("Satan's Headguard", "REQ: 500 STR", "", 1, new Stats(500, 500, 500, 500), 100);
		}
		if (type == R_SE){
			return new Equipment("Running Shoes", "REQ: 5 STR", "", 4, new Stats(5, 5, 1, 1), 100);
		}
		if (type == R_BT){
			return new Equipment("Rain Boots", "REQ: 15 STR", "", 4, new Stats(15, 15, 5, 5), 100);
		}
		if (type == A_SE){
			return new Equipment("Armor Shoes", "REQ: 45 STR", "", 4, new Stats(45, 45, 10, 10), 100);
		}
		if (type == G_SL){
			return new Equipment("God's Sandals", "REQ: 100 STR", "", 4, new Stats(100, 100, 100, 100), 100);
		}
		return null;
	}
