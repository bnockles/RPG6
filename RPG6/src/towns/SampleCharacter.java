...
public class SampleCharacter {
	...
	public void setEquipments(ArrayList<Item> items) {
		this.items = items;
	}
	...
	public SampleCharacter(int cur, String nm, String imageLocation, int locationX, int locationY, ArrayList<Item> playerInventory){
		this.currency = cur;
		this.name = nm;
