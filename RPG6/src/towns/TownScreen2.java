...
import directors.Screen;
	...
	public class TownScreen2 extends Screen implements KeyListener{
		...
		public TownScreen2(Game game) {
			...
			this.merchant1 = new Merchant("Samantha","Female","Kathy is a merchant, merchants sell specific items based on what town you are in, Kathy sells potions." , true);
			this.rpsMan = new Minigame("House","Male","Bob triggers a minigame, there are different minigames in each town that will help you earn money in the game, Bob lets you play rock, paper, scissors in this demo." , true);
			this.storageDude = new Storage("Chase","Male","Greg is your storage guy, he is in every town in case you want to store items and then take them back for later.", true);
			update();
		}
